        ...
        <div class="row g-5">
          ...
          <div class="col-lg-6">
            ...
            <div class="action-btns">
              <button class="btn-more" onclick="showToast('Msg sent! We will contact you soon.')">
                <i class="fas fa-envelope me-2"></i>More Detail
              </button>
              <a href="https://wa.me/923353924555?text=I am interested in ${encodeURIComponent(product.name)}" target="_blank" class="btn-whatsapp">
